...
WebUI.navigateToUrl('http://bs-srvwebqa/SimuladorEnPunta/')

WebUI.maximizeWindow()

WebUI.setText(findTestObject('Object Repository/Simulador_Punta/Page_Login/input_Login_UserName'), GlobalVariable.UserSimulador)

WebUI.setEncryptedText(findTestObject('Object Repository/Simulador_Punta/Page_Login/input_Oficina_Password'), GlobalVariable.PasswordSimulador)

WebUI.click(findTestObject('Object Repository/Simulador_Punta/Page_Login/input_Oficina_btn btn-primary'))
