...
WebUI.verifyTextPresent('Por favor revisa nuevamente el correo ingresado', false)

WebUI.click(findTestObject('Rapidito No Cliente/en caso de correo malo/Page_/img'))

WebUI.click(findTestObject('Object Repository/Rapidito No Cliente/Page_/input_VER TUTORIAL_btnContinuar'))

WebUI.click(findTestObject('Rapidito No Cliente/Page_CRDITO WEB NO CLIENTES/button_CONTINUAR'))
...
//WebUI.click(findTestObject('Rapidito No Cliente/upload file_fecha/Page_CRDITO WEB NO CLIENTES/input_Subir_InputCertificadoLaboral'))
...
WebUI.callTestCase(findTestCase('Aprobacion Documento'), [:], FailureHandling.STOP_ON_FAILURE)
