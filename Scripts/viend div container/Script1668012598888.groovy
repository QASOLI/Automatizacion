...
WebUI.click(findTestObject('Object Repository/Simulador_Punta/buscando divs/Page_Index/a_SIMULADOR'))

WebUI.click(findTestObject('Object Repository/Simulador_Punta/buscando divs/Page_Index/a_MODIFICAR OFERTA'))

WebUI.setText(findTestObject('Object Repository/Simulador_Punta/buscando divs/Page_Simulador/input_Identificacin_inputIdentificacion'), 
    '1722225610')

WebUI.click(findTestObject('Object Repository/Simulador_Punta/buscando divs/Page_Simulador/button_Buscar'))

WebUI.click(findTestObject('Object Repository/Simulador_Punta/buscando divs/Page_Simulador/button_Generar Oferta'))
...
if (WebUI.click(findTestObject('Simulador_Punta/Page_Simulador/button_Ofertar'))) {
    ...
    WebUI.click(findTestObject('Simulador_Punta/buscando divs/Page_Simulador/button_Generar Campaa'))
}
